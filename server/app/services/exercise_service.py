...
class ExerciseService:
    ...
    def get_exercise_by_id(exercise_id: int):
        return ExerciseRepository.get_by_id(exercise_id)
    ...
    def delete_system_exercise(current_user_id: int, exercise_id: int):
        ...
        if not user or user.role != "admin":
            return None, "Only admin can delete system exercises."
    ...
    def delete_custom_exercise(current_user_id: int, exercise_id: int):
        ...
        if exercise.is_system:
            return None, "System exercises cannot be deleted here."

        if exercise.created_by_user_id != current_user_id:
            return None, "You are not allowed to delete this exercise."
